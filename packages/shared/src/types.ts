...
export interface CategoryScore {
  ...
  concrete: number;                // Failure-aware share of verified depth: solid × (caught mistakes / total mistakes) (0-100, <= solid)
  discernment?: number;            // Correctly identifies success/failure in both directions (0-100)
  failureAwareness?: number;       // Caught-mistake ratio: admitted mistakes / total mistakes (0-100)
